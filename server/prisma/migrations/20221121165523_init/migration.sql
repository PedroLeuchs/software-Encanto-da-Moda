/*
  ...
  - You are about to alter the column `cpf` on the `Cadastro_cliente` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `cadastro_clienteCpf` on the `Vendas_balcao` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
